...
# video_capture = cv2.VideoCapture("woman.mp4")
# video_capture = cv2.VideoCapture("vids/woman_2.mp4")
video_capture = cv2.VideoCapture("vids/hania.mp4")
...
while True:
    ...
    if ret:
        ...
        cv2.putText(frame, "Wink Left : {}".format(TOTAL_LEFT), (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255),
                    2)
